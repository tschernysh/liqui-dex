  ...
  return (
    <header data-transparent={isHeaderTransparent} data-hidden={scrollDirection === 'down'} className={s.header}>
      ...
      <nav onClick={setIsMenuOpen.bind(null, isMenuOpen ? false : isMenuOpen)} data-open={isMenuOpen} className={s.header__links}>
        ...
        <a target='_blank' href={'https://bscscan.com/address/0x90a3eaf71f734edb6eacc20537bf8836235dd291#code'}><IoDocumentText /> Smart-contract</a>
        <a target='_blank' href='/LiquiDex.pdf' ><HiClipboardDocumentList /> Audit</a>
        <a target='_blank' href={'https://t.me/LiquidexCommunity'}><BiLogoTelegram /> Telegram</a>
      </nav>
